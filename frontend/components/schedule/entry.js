...
const Entry = props => (
    <Flex w="auto" minW="200px" h="auto" flexDirection="column" flexWrap="wrap" alignSelf="center" marginTop="25px" marginLeft={["5%", "5%", "5%", "300px","550px", "600px"]} marginRight={["5%", "5%", "5%", "300px","550px", "600px"]} alignSelf="center" borderColor="black" borderWidth="10px" rounded="lg" backgroundColor="white" >
