  ...
  props.teammates.map((data, index) => {
    teammates.push(
      <Text
        p={0}
        m={0}
      >{`${data.first_name} ${data.last_name} - ${data.form}`}</Text>
    );
  });
    ...
    >
      ...
      >
        ...
        <Text
          ...
          fontWeight="400"
        >
          <strong fontWeight="700">Технологии:</strong>
        </Text>
        <Flex
          paddingTop={["10px", "10px", "10px", "15px"]}
          flexDirection="row"
          flexWrap="wrap"
        >
          {tech}
        ...
        >
          <Text
            ...
            lineHeight="1.5"
          >
            <strong fontWeight="700">Участници:</strong>
          </Text>
          <Text
            lineHeight="1.5"
            fontFamily="Rubik"
