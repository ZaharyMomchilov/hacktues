      ...
      <Formik
        ...
        onSubmit={(values, actions) => {
          setTimeout(() => {
            ...
            router.push("/").catch(function (error) {
              if (error.response) {
          ...
          >
            ...
            <Field name="last_name">
              {({ field, form }) => (
                ...
                >
                  <FormLabel fontFamily="Rubik" fontSize="15px" htmlFor="text">
                    Фамилия (на кирилица)
                  </FormLabel>
                  <Input
                    _invalid={{
            ...
            <Field name="alergies">
              {({ field, form }) => (
                <FormControl
                  ...
                  mr="5px"
                  {...field}
                  isInvalid={form.errors.alergies && form.touched.alergies}
                >
                  <FormLabel
                    paddingTop="15px"
                    paddingBottom="5px"
                ...
                >
                  ...
                  >
                    ...
                    <Link href="/regulation">
                      <a style={{ color: "green" }}>регламента на хакатона</a>
                    </Link>
                  </CustomCheckbox>
                </FormControl>
              )}
