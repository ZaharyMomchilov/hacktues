...
var CUIAutoComplete = function CUIAutoComplete(props) {
  var items = props.items,
    ...
    optionFilterFunc =
      _props$optionFilterFu === void 0
        ? defaultOptionFilterFunc
        : _props$optionFilterFu,
    itemRenderer = props.itemRenderer,
    _props$highlightItemB = props.highlightItemBg,
    highlightItemBg =
      _props$highlightItemB === void 0 ? "gray.100" : _props$highlightItemB,
    ...
    downshiftProps = _objectWithoutPropertiesLoose(props, [
      "items",
      "optionFilterFunc",
      "itemRenderer",
      "highlightItemBg",
  ...
  return createElement(
      ...
      createElement(
        ...
        selectedItems.map(function (selectedItem, index) {
          return createElement(
            ...
            createElement(TagLabel, null, selectedItem.label),
    ...
    createElement(
      ...
      createElement(
        Button,
        Object.assign({}, toggleButtonStyleProps, getToggleButtonProps(), {
