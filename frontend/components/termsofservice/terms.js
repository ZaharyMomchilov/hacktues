...
const panels = [
  {
    title: <Markdown>### Политика за поверителност на Hack TUES 6</Markdown>,
    description: <Markdown>{parts[0]}</Markdown>,
  },
  {
    title: <Markdown>### Какви лични данни събираме и за какви цели?</Markdown>,
    description: <Markdown>{parts[1]}</Markdown>,
  },
  {
    title: (
      <Markdown>### С кого и как можем да споделим ваши лични данни?</Markdown>
    ),
    description: <Markdown>{parts[2]}</Markdown>,
  },
  {
    title: <Markdown>### Колко дълго ги пазим?</Markdown>,
    description: <Markdown>{parts[3]}</Markdown>,
  },
  {
    title: (
      <Markdown>### Данни на непълнолетни участници в Hack TUES 6</Markdown>
    ),
    description: <Markdown>{parts[4]}</Markdown>,
  },
  {
    title: (
      <Markdown>### Данни на непълнолетни участници в Hack TUES 6</Markdown>
    ),
    description: <Markdown>{parts[5]}</Markdown>,
  },
  {
    title: <Markdown>### Контакт с нас</Markdown>,
    description: <Markdown>{parts[6]}</Markdown>,
  },
];
