...
export default function Register(props) {
  ...
  const SignupSchema = Yup.object().shape({
    ...
    last_name: Yup.string()
      ...
      .max(50, "Too Long!")
      .matches(/^[А-Я][а-я]+$/, "използвай само кирилица")
      .matches(/[а-я]/, "включен ти е CAPS LOCK-а :D")
      .matches(/[А-Я]/, "използвай главна буква :)")
      .required("Задължително"),
    email: Yup.string().email("Невалиден имейл").required("Задължително"),
    reemail: Yup.string()
      .email("Невалиден имейл")
      .equalTo(Yup.ref("email"), "Имейлите не са еднакви")
      .required("Задължително"),
    password: Yup.string()
      .matches(/[A-ZА-Я]/, "използвай минимум 1 главна буква")
      .matches(/[a-zа-я]/, "използвай минимум 1 малка буква")
    ...
    repassword: Yup.string()
      .equalTo(Yup.ref("password"), "Паролите не са еднакви")
      .required("Задължително"),
    phone: Yup.string().matches(/^0\d{9}$/, "използвай валиден телефон"),
  });
  ...
  if (router.query["code"] != undefined) {
    ...
    payload.append(
      "redirect_uri",
      "https://hacktues.com/registration/second_step"
    );
    ...
    axios({
      ...
      cookies.set("discord_refresh", response.data.refresh_token, {
        path: "/",
      });
              ...
              .then(function (response) {
                if (response.status == 201) {
                  toast({
                    ...
                    description:
                      "Акаунтът беше успешно създаден и трябва да се потвърди, чрез имейл",
                    status: "success",
                    duration: 9000,
                  });
                  ...
                  for (const [key, value] of Object.entries(
                    ...
                    if (error.response.data.discord_id[0]) {
                      actions.setFieldError(
                        "email",
                        error.response.data.discord_id[0]
                      );
                    }
                  }
                } else if (router.query["error"] == "access_denied") {
                ...
                {({ field, form }) => (
                  ...
                  >
                    ...
                    <Input
                      ...
                      _focus={{
                        borderColor: "#a5cf9f",
                        boxShadow: "0px 2px 0px 0px #a5cf9f",
                      }}
                      variant="flushed"
                      borderTop={0}
                      borderRight={0}
              ...
              <Field name="reemail">
                {({ field, form }) => (
                  <FormControl
                    ...
                    mr="5px"
                    isRequired
                    isInvalid={form.errors.reemail && form.touched.reemail}
                  >
                    <FormLabel
                      paddingTop="15px"
                      paddingBottom="5px"
              ...
              <Field name="tshirt_size">
                {({ field, form }) => (
                  <FormControl
                    ...
                    mr="5px"
                    {...field}
                    isInvalid={form.errors.tshirt && form.touched.tshirt}
                    isRequired
                  >
                    <FormLabel
                      paddingTop="15px"
                ...
                <Field name="regulation">
                  {({ field, form }) => (
                    ...
                    >
                      ...
                      >
                        Съгласен съм с{" "}
                        <Link isExternal href="/regulation">
                          <a style={{ color: "green" }} onClick={onClose}>
                  ...
                  {({ field, form }) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <Link
                          isExternal
                          href="https://hacktues.pythonanywhere.com/static/frontend/Политика за поверителност.pdf"
                        >
                          <a style={{ color: "green" }} onClick={onClose}>
                            политиката за поверителност на Hack TUES GG
                          </a>
                        </Link>
                      </CustomCheckbox>
                    </FormControl>
