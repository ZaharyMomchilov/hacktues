  ...
  if (event.link) {
    ...
    return (
      <span>
        ...
        <a style={{ textDecoration: "none" }}>
          {"Очакваме те"}&nbsp;-&gt;&nbsp;
          <Link textDecoration="underline" target="_blank" href={event.link}>
            {"Google Meet"}
          </Link>
        </a>
      </span>
    ...
    return (
      <span>
        ...
        <Text>{event.desc}</Text>
        <a style={{ textDecoration: "none" }}>
          {"Нещо свързано с Discord"}&nbsp;-&gt;&nbsp;
          <Link textDecoration="underline" target="_blank" href={event.discord}>
            {"Discord"}
          </Link>
        </a>
      </span>
    ...
    return (
      <span>
        ...
        <Text>{event.desc}</Text>
        <a style={{ textDecoration: "none" }}>
          <Link textDecoration="underline" target="_blank"></Link>
        </a>
      </span>
    );
  }
