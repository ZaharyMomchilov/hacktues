        ...
        <Formik justifyContent="center" initialValues={{name: '', project_name: '', project_description: '', github_link: ''}}
                ...
                {(props) => (
					...
					<Field name="name">
						...
						<FormControl paddingTop={["15px","15px","15px","0px"]} flexGrow={1} w={["100%","100%","33%","33%", "33%"]} mr="5px" isRequired isInvalid={form.errors.name && form.touched.name}>
							...
							<FormHelperText>Впоследствие името на отборът не може да се променя</FormHelperText>
                ...
                <Field name="users">
						...
						<FormLabel fontFamily="Rubik" fontSize="15px" htmlFor="text">Избери участници</FormLabel>
							<CUIAutoComplete id="users" onCreateItem={() => {}} {...field} placeholder="Добави участници" toggleButtonStyleProps={{display:"none"}} tagStyleProps={{ padding: "5px",sx:{ "& button": { border: "none"},},
                ...
                <Button cursor="pointer" _focus={{outline:"none"}} display="flex" w="33%" justifyContent="center" mt={4} colorScheme="green" border="0"
