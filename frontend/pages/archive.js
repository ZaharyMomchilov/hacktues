...
export default function Archive() {
    return (
        <Flex justifyContent="center" alignItems="center" flexDirection={["column","column","column","row"]} flexWrap="wrap" pb={["300px", "300px", "300px", "200px"]} pt="25px">
            <Flex rounded="lg" mt="25px" ml="50px" mr="50px" fontFamily="Rubik" h={["325px","325px","300px","300px"]} flexDirection="column" flexWrap="wrap" w={["auto","400px","500px","500px"]} backgroundColor="white">
				<Flex>
            ...
            <Flex rounded="lg" mt="25px" ml="50px" mr="50px" fontFamily="Rubik" h={["325px","325px","300px","300px"]} flexDirection="column" flexWrap="wrap" w={["auto","400px","500px","500px"]} backgroundColor="#232323">
				<Flex>
            ...
            <Flex rounded="lg" mt="25px" ml="50px" mr="50px" fontFamily="Rubik" h={["325px","325px","300px","300px"]} flexDirection="column" flexWrap="wrap" w={["auto","400px","500px","500px"]} backgroundColor="#343a40">
				<Flex>
			...
			<Flex rounded="lg" mt="25px" ml="50px" mr="50px" fontFamily="Rubik" h={["325px","325px","300px","300px"]} flexDirection="column" flexWrap="wrap" w={["auto","400px","500px","500px"]} bgGradient="linear(to-b, #3d2238, #ce402c)">
				<Flex>
