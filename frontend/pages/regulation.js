...
const panels = [
  {
    title: <Markdown>### КАКВО ПРЕДСТОИ ПРЕДИ HACK TUES GG</Markdown>,
    description: (
      <Markdown
        options={{
          forceBlock: true,
  ...
  {
    title: <Markdown>### КАК ДА УЧАСТВАТЕ?</Markdown>,
    description: (
      <Markdown
        options={{
          createElement(type, props, children) {
  ...
  {
    title: <Markdown>### ПРОГРАМА</Markdown>,
    description: (
      <Markdown
        options={{
          createElement(type, props, children) {
  ...
  {
    title: <Markdown>### ПРОЕКТИ</Markdown>,
    description: (
      <Markdown
        options={{
          createElement(type, props, children) {
  ...
  {
    title: <Markdown>### ТЕХНОЛОГИИ</Markdown>,
    description: (
      <Markdown
        options={{
          createElement(type, props, children) {
  ...
  {
    title: <Markdown>### МЕНТОРИ</Markdown>,
    description: (
      <Markdown
        options={{
          createElement(type, props, children) {
  ...
  {
    title: <Markdown>### ОЦЕНЯВАНЕ ОТ МЕНТОРИТЕ</Markdown>,
    description: (
      <Markdown
        options={{
          createElement(type, props, children) {
  ...
  {
    title: <Markdown>### ПОЛУФИНАЛИ И ФИНАЛИ</Markdown>,
    description: (
      <Markdown
        options={{
          createElement(type, props, children) {
  ...
  {
    title: <Markdown>### ОЦЕНЯВАНЕ ОТ ЖУРИТО</Markdown>,
    description: (
      <Markdown
        options={{
          createElement(type, props, children) {
  ...
  {
    title: <Markdown>### ОТГОВОРНОСТ</Markdown>,
    description: (
      <Markdown
        options={{
          createElement(type, props, children) {
  ...
  {
    title: <Markdown>### ДИСКВАЛИФИКАЦИЯ</Markdown>,
    description: (
      <Markdown
        options={{
          createElement(type, props, children) {
  ...
  {
    title: <Markdown>### ТОРМОЗ</Markdown>,
    description: (
      <Markdown
        options={{
          createElement(type, props, children) {
...
export default function Regulation() {
  return (
    <Box pb={["200px", "50px"]} pt="50px">
      <Flex
        marginLeft={["25px", "25px", "100px", "250px"]}
        marginRight={["25px", "25px", "100px", "250px"]}
        mb="50px"
        background="white"
        p="15px"
        rounded="lg"
