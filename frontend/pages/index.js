...
export default function Home() {
    ...
    return( 
        <Box>
            ...
            <Flex marginBottom="20px" marginTop="20px" rounded="lg" marginLeft="5%"  marginRight="5%" w="100%" alignItems="center"  flexDirection="column" flexWrap="wrap">
                        ...
                        <Center justifyContent="center" alignItems="center" flexDirection="row" flexWrap="wrap">
                          <Center  marginRight="30px" width={"295px"} h={"300px"}>
                        	  <Image objectFit="scale-down" display="block" width="100%" height="100%" title="TelebidPro" src="/Logos/Alpha - TelebidPro/Telebid Pro light.svg"></Image>
                          </Center>
					                <Center marginRight="30px" width={"295px"} h={"300px"}>
                              <Image objectFit="scale-down" display="block" width="100%" height="100%" title="SAP" src="/Logos/Alpha - SAP/SAP_grad_R_pref.png"></Image>
                           
                        	  </Center>
                          <Center marginRight="30px" width={"295px"} h={"300px"}>
                        	  <Image objectFit="scale-down" display="block" width="100%" height="100%" title="Experian" src="/Logos/Alpha - Experian/Experian BM TM RGBsm.png"></Image>
                          </Center>
					                <Center marginRight="30px" justifyContent="center" alignContent="center" width={"295px"} h={"300px"}>
                        	  <Image objectFit="scale-down" display="block" width="100%" height="100%" title="VMWare" src="/Logos/Alpha - VMWare/VMW_09Q3_LOGO_Corp_Gray.png"></Image>
                          </Center>
                          <Center  justifyContent="center" alignContent="center" width={"295px"} h={"300px"}>
                        	  <Image objectFit="scale-down" display="block" width="100%" height="100%" title="VMWare" src="/Logos/Alpha - VMWare/VMW_09Q3_LOGO_Corp_Gray.png"></Image>
                          </Center>
                      ...
                      <Flex marginTop="20px" marginBottom="20px" w="100%" backgroundColor="white" rounded="lg" padding="15px" alignItems="center" flexDirection="column" flexWrap="wrap">
                        ...
                        <Center justifyContent="center" alignItems="center" flexDirection="row" flexWrap="wrap">
                          <Center marginRight="30px" width={"295px"} h={"300px"}>
                        	  <Image objectFit="scale-down" display="block" width="100%" height="100%" title="A1" src="/Logos/Beta - A1/A1_01_08RED_3_L.png"></Image>
                          </Center>
					                <Center marginRight="30px" width={"295px"} h={"300px"}>
                      ...
                      <Flex marginTop="20px" marginBottom="30px" w="100%" backgroundColor="white" rounded="lg" padding="15px" alignItems="center" flexDirection="column" flexWrap="wrap">
                        ...
                        <Center justifyContent="center" alignItems="center" flexDirection="row" flexWrap="wrap">
                          <Center marginRight="30px" width={"295px"} h={"300px"}>
                        	  <Image objectFit="scale-down" display="block" width="100%" height="100%" title="Astea Solutions" src="/Logos/Gamma - Astea Solutions/astea_logo.svg"></Image>
                          </Center>
					                <Center marginRight="30px" width={"295px"} h={"300px"}>
                        	  <Image objectFit="scale-down" display="block" width="100%" height="100%" title="Bosch" src="/Logos/Gamma - Bosch/BOSCH_ENGLISH_RGB.svg"></Image>
                          </Center>
                          <Center marginRight="30px" width={"295px"} h={"300px"}>
                        	  <Image objectFit="scale-down" display="block" width="100%" height="100%" title="CPD" src="/Logos/Gamma - CPD/CPD_a_DaisyTechCompany.png"></Image>
                          </Center>
                          <Center marginRight="30px" width={"295px"} h={"300px"}>
                          ...
                          <Center marginRight="30px" width={"295px"} h={"300px"}>
                        	  <Image objectFit="scale-down" display="block" width="100%" height="100%" title="Dopamine" src="/Logos/Gamma - Dopamine/Копие на Dopamine - image001.png"></Image>
                          </Center>
                          <Center  width={"295px"} h={"300px"}>
                        	  <Image objectFit="scale-down" display="block" width="100%" height="100%" title="Paysafe" src="/Logos/Gamma - Paysafe/PAYSAFE_logo.png"></Image>
                          </Center>
                        </Center>
                      </Flex>
           </Flex>
