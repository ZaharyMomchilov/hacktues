  ...
  return (
    ...
    >
                ...
                <Field name="form">
                  {({ field, form }) => (
                    <FormControl
                      ...
                      w={["100%", "100%", "100%", "33%"]}
                      mr="5px"
                      isInvalid={form.errors.form && form.touched.form}
                      {...field}
                      isRequired
                    >
                      <FormLabel
      ...
      >
        ...
        <Text fontFamily="Rubik" mb="15px">
          Всеки участник в хакатона трябва да предаде декларация за участие по
          образец най-късно до 08.03. В противен случай няма да бъде допуснат до
          участие в Hack TUES GG. Декларация:
        </Text>
        <Text fontFamily="Rubik" p={0} m={0}>
          {"За пълнолетни"}&nbsp;
          <Link
            isExternal
            href="https://hacktues.pythonanywhere.com/static/frontend/%D0%94%D0%B5%D0%BA%D0%BB%D0%B0%D1%80%D0%B0%D1%86%D0%B8%D1%8F_%D0%BF%D1%8A%D0%BB%D0%BD%D0%BE%D0%BB%D0%B5%D1%82%D0%BD%D0%B8.pdf"
            fontFamily="Rubik"
            color="green"
        ...
        <Text fontFamily="Rubik" p={0} m={0}>
          ...
          <Link
            isExternal
            href="https://hacktues.pythonanywhere.com/static/frontend/%D0%94%D0%B5%D0%BA%D0%BB%D0%B0%D1%80%D0%B0%D1%86%D0%B8%D1%8F_%D0%BD%D0%B5%D0%BF%D1%8A%D0%BB%D0%BD%D0%BE%D0%BB%D0%B5%D1%82%D0%BD%D0%B8.pdf"
            fontFamily="Rubik"
            color="green"
            textDecoration="underline"
          >
        ...
        >
          ...
          <Link
            isExternal
            href="https://forms.gle/uTCmyJiB9en6MY4T8"
            fontFamily="Rubik"
            color="green"
            textDecoration="underline"
          >
...
const CheckboxArrayControl = (props, { children }) => {
  ...
  return (
    <Switch
      colorScheme="green"
      css={{ boxShadow: "none", alignSelf: "center", outline: "none" }}
      {...field}
