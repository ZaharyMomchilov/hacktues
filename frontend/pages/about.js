...
const Panel = (props) => {
    return(
        ...
        <Flex display="block"  p="10px" marginLeft={["20px", "20px", "100px", "100px"]} marginRight={["20px", "20px", "100px", "100px"]} marginTop="5%"  flexDirection="column" flexWrap="wrap" justifyContent="center" height="auto" borderColor="black" borderWidth="10px" rounded="lg" backgroundColor="white" overflow="hidden">
            <Text lineHeight="1.5" textAlign="justify" fontFamily="Rubik" paddingBottom="10px" paddingLeft="10px">
            <span style={{"font-size":"20px","fontFamily":"llpixel"}}>Hack&nbsp;</span>
                <span style={{"fontSize":"20px","fontFamily":"llpixel","color":"green"}}>
                    TUES
                </span>&nbsp;
...
<br></br><br></br>Всяка година Hack TUES се организира от координационен екип доброволци от 11. клас, който се грижи за цялостната организация на събитието под менторството на <a style={{"color":"green"}} href="https://aztues.bg/">АЗТУЕС</a> и ръководството на ТУЕС. Тази година сред организаторите има и по един представител от 9. и 10. клас. 
&nbsp;<br></br><br></br><span style={{"font-size":"20px","fontFamily":"llpixel"}}>Hack&nbsp;</span>
                <span style={{"fontSize":"20px","fontFamily":"llpixel","color":"green"}}>
                    TUES&nbsp;
                </span><span style={{"color": "#105231", "fontFamily":"llpixel", "font-size":"20px"}}>GG</span> ще бъде за първи път изцяло онлайн. Ще се проведе в периода 11-14 март.
            </Text>
        </Flex>
